...
export default function HalamanDaftarKategori() {
  ...
  const tampilNotifikasiKategori = () => {
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
        <div className="w-full max-w-lg bg-white rounded-3xl shadow-2xl p-6 relative">
          <button
            ...
            className="absolute top-4 right-4 h-8 w-8 rounded-full bg-slate-100 text-slate-500 flex items-center justify-center"
          >
            <i className="fas fa-times"></i>
          </button>
          <h3 className="text-2xl font-semibold text-brand-dark mb-2">{editingId ? 'Ubah Kategori' : 'Tambah Kategori'}</h3>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end gap-2">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 bg-brand-accent text-brand-dark font-semibold px-5 py-2 rounded-xl disabled:opacity-60"
              >
                {saving ? (
                  <>
  ...
  const tampilHalamanKategori = () => {
    if (loading) {
      return (
        <AdminLayout title="Halaman Daftar Kategori">
        ...
        <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/50 p-6 border border-slate-100">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-6">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 bg-brand-accent text-brand-dark font-bold px-5 py-2.5 rounded-xl shadow-lg shadow-brand-accent/20"
            >
